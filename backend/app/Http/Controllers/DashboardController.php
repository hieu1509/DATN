...
class DashboardController extends Controller
{
    public function Dashboard()
    {
        ...
        $top10productbought = Product::with('variants.orderDetail')
        ...
        // dd($totalSales);
        return view('admin.pages.dashboard', compact('totalmoney', 'totalBoughtProduct', 'phantramdahuy', 'donhangdangchoxuly', 'tongdonhang', 'phantramdahuy', 'phantramdangchoxuly', 'totalProduct', 'top10Category', 'top5LastestComment', 'top10productbought', 'top5Users', 'monthlySales', 'percentages', 'totalSales', 'YearSales'));
    }
}
