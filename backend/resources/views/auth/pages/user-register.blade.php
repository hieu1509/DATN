                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card mt-4">
                            <div class="card-body p-4">
                                ...
                                <div class="p-2 mt-4">
                                    <form class="needs-validation" method="POST" action="{{ route('register.user.post') }}" novalidate>
                                        @csrf
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="position-relative auth-pass-inputgroup">
                                                ...
                                                <button class="btn btn-link position-absolute end-0 top-0 text-decoration-none text-muted password-addon"
                                                    type="button" id="password-addon" onclick="togglePasswordVisibility()"><i class="ri-eye-fill align-middle"></i></button>
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="hidden" name="role" value="user"> Người dùng
                                        </div>                                        
                        ...
                        <div class="mt-4 text-center">
                            <p class="mb-0">Bạn đã có tài khoản? <a href="{{ route('login.user') }}" class="fw-semibold text-primary text-decoration-underline"> Đăng nhập </a></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <script>
            function togglePasswordVisibility() {
                ...
                if (passwordInput.type === 'password') {
                    ...
                    passwordAddon.innerHTML = '<i class="ri-eye-off-fill align-middle"></i>'; // Thay đổi biểu tượng
                } else {
                    passwordInput.type = 'password';
                    passwordConfirmInput.type = 'password';
                    passwordAddon.innerHTML = '<i class="ri-eye-fill align-middle"></i>'; // Thay đổi biểu tượng
                }
            }
        </script>
    </div>
