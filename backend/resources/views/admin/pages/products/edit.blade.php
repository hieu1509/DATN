                    ...
                    <div class="card">
                        <div class="card-header">
                            <ul class="nav nav-tabs-custom card-header-tabs border-bottom-0" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="tab" href="#addproduct-variant " role="tab">
                                        Variant 
                                    </a>
                                </li>
                            </ul>
                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="addproduct-variant" role="tabpanel">
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="mb-3">
                                                <label class="form-label" for="meta-title-input">Name variant</label>
                                        ...
                                        <div class="col-lg-8">
                                            <div class="mb-3">
                                                <label class="form-label" for="meta-keywords-input">Value</label>
                                                <input type="text" class="form-control" placeholder="Enter meta keywords" id="meta-keywords-input">
                                            </div>
                                        </div>
                                        <!-- end col -->
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3">
                                            <button type="button" class="btn btn-success waves-effect waves-light">Create variant</button>
                                        </div>
                                    </div>
                                </div>
                                <!-- end tab pane -->
