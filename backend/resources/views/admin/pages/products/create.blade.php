                ...
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div>
                                <label>Mô tả</label>
                                <textarea class="@error('content') is-invalid @enderror" name="content" id="ckeditor-classic">{{ old('content') }}
                                </textarea>
                                @error('content')
                                <div class="invalid-feedback fs-6">
                                    <div class="alert alert-danger">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <textarea name="description" id="description" class="form-control  @error('description') is-invalid @enderror" placeholder="" rows="12">{{ old('description') }}</textarea>
                            @error('description')
                            <div class="invalid-feedback fs-6">
                                <div class="alert alert-danger">
                                    {{ $message }}
                                ...
                                <div class="variant-row row">
                                    ...
                                    <div class="col-lg-2">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input name="listed_price[]" value="{{ old('listed_price[]') }}" type="number" class="form-control  @error('listed_price.*') is-invalid @enderror"
                                    ...
                                    <div class="col-lg-2">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input name="sale_price[]" value="{{ old('sale_price[]') }}" type="number" class="form-control @error('sale_price.*') is-invalid @enderror"
                                    ...
                                    <div class="col-lg-2">
                                        <div class="mb-3">
                                            ...
                                            <input name="quantity[]" value="{{ old('quantity[]') }}" type="number" class="form-control @error('quantity.*') is-invalid @enderror"
