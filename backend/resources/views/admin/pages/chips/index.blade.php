...
<div class="page-content">
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{$items->name}}</td>
                <td>
                    <a href="{{route('admins.chips.edit',['id'=>$items->id])}}" class="btn btn-warning d-inline-block me-1">Sửa</a>
    ...
    <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <!-- Thẻ a nằm bên trái -->
            <a class="btn btn-success" href="{{route('admins.chips.create')}}">Thêm sản phẩm</a>
