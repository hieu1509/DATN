                        ...
                        <main id="main" class="site-main">
                            <article class="post format-image">
                                ...
                                <header class="entry-header">
                                    ...
                                    <div class="entry-meta">
                                        ...
                                        <span class="posted-on">
                                            <a rel="bookmark" href="#">
                                                <time datetime="2017-03-23T08:06:09+00:00" class="entry-date published">March
                                                    23, 2017</time>
                                            </a>
                                        </span>
                                        <!-- .posted-on -->
                                ...
                                <div class="entry-content" itemprop="articleBody">
                                    <p>A desktop computer is a computer that is designed to stay in a single location. It may be
                                        a tower or an all-in-one PC. Lorem Ipsum is simply dummy text of the printing and
                                    ...
                                    <p class="highlight">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed tincidunt,
                                        ...
                                        velit, cursus molestie lectus mollis et.</p>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <p class="highlight-light">Mauris tempus erat laoreet turpis lobortis, eu tincidunt
                                                erat fermentum.</p>
                                    ...
                                    <li class="comment byuser comment-author-admin bypostauthor even thread-even depth-1">
                                        <div class="comment_container">
                                            ...
                                            <div class="comment-text">
                                                <div class="meta">
                                                    <strong class="woocommerce-review__author" itemprop="author">Jane
                                                        Smith</strong>
                                                    <time datetime="2017-03-23T08:06:09+00:00"
                                                        class="woocommerce-review__published-date">July 24, 2017</time>
                                                </div>
                                ...
                                <div class="comment-respond" id="respond">
                                    ...
                                    <form novalidate="" class="comment-form" id="commentform" method="post"
                                        ...
                                        <p class="comment-form-url">
                                            ...
                                            <input type="url" maxlength="200" size="30" value=""
                                                name="url" id="url">
                                        </p>
                                        <p class="form-submit">
                                    ...
                                    <div class="posts">
                                        <div class="post-item">
                                            ...
                                            <div class="post-content">
                                                <a href="blog-single.html" class="post-name" tabindex="-1">Why you should
                                                    choose dedicated Desktop PC Computer</a>
                                                <span class="comments-link">
                                        ...
                                        <div class="post-item">
                                            ...
                                            <!-- .post-thumbnail -->
                                            <div class="post-content">
                                                <a href="blog-single.html" class="post-name" tabindex="-1">Tech Terms you
                                                    should know before your adventure</a>
                                                <span class="comments-link">
                                                    <a href="#">Leave a comment</a>
                                                </span>
                                            </div>
                                        ...
                                        <div class="post-item">
                                            ...
                                            <!-- .post-thumbnail -->
                                            <div class="post-content">
                                                <a href="blog-single.html" class="post-name" tabindex="-1">How to build your
                                        ...
                                        <div class="post-item">
                                            ...
                                            <!-- .post-thumbnail -->
                                            <div class="post-content">
                                                <a href="blog-single.html" class="post-name" tabindex="-1">Top 10 Best
                                                    Graphical Games for testing your Hardware</a>
                                                <span class="comments-link">
                                                    <a href="#">Leave a comment</a>
                                                </span>
                                            </div>
