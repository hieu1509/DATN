                            ...
                            <div class="type-page hentry">
                                <div class="entry-content">
                                    <div class="woocommerce">
                                        <div class="woocommerce-info">Bạn có mã giảm giá? <a data-toggle="collapse" href="#checkoutCouponForm" aria-expanded="false" aria-controls="checkoutCouponForm" class="showlogin">Nhấp vào đây để nhập mã của bạn</a>
                                        </div>
                                        <div class="collapse" id="checkoutCouponForm">
                                            <form method="post" class="checkout_coupon">
                                                ...
                                                <p class="form-row form-row-last">
                                                    <input type="submit" value="Áp dụng mã" name="apply_coupon" class="button">
                                                </p>
                                                <div class="clear"></div>
                                            </form>
                                        </div>
                                                        ...
                                                        <div class="woocommerce-billing-fields__field-wrapper-outer">
                                                            <div class="woocommerce-billing-fields__field-wrapper">
                                                                ...
                                                                <p id="billing_address_2_field" class="form-row form-row-wide address-field">
                                                                    <input type="text" value="" placeholder="Căn hộ, phòng, đơn vị... (tùy chọn)" id="billing_address_2" name="billing_address_2" class="input-text ">
                                                                </p>
                                                                ...
                                                                <p id="billing_state_field" class="form-row form-row-wide validate-required validate-email">
                                                                    <label class="" for="billing_state">Tỉnh / Hạt
                                                                        <abbr title="required" class="required">*</abbr>
                                                                    </label>
                                                                ...
                                                                <p id="billing_postcode_field" class="form-row form-row-wide address-field validate-postcode validate-required">
                                                                    <label class="" for="billing_postcode">Mã bưu điện / ZIP
                                                                        <abbr title="required" class="required">*</abbr>
                                                                    </label>
                                                    ...
                                                    <div class="woocommerce-shipping-fields">
                                                        ...
                                                        <div class="shipping_address collapse" id="shipping-address">
                                                            <div class="woocommerce-shipping-fields__field-wrapper">
                                                                ...
                                                                <p data-priority="90" id="shipping_postcode_field" class="form-row form-row-wide address-field validate-postcode validate-required">
                                                                    <label class="" for="shipping_postcode">Mã bưu điện / ZIP
                                                                        <abbr title="required" class="required">*</abbr>
                                                                    </label>
                                                    ...
                                                    <div class="woocommerce-additional-fields">
                                                        <div class="woocommerce-additional-fields__field-wrapper">
                                                            <p id="order_comments_field" class="form-row notes">
                                                                ...
                                                                <textarea cols="5" rows="2" placeholder="Ghi chú về đơn hàng của bạn, ví dụ như ghi chú đặc biệt cho việc giao hàng." id="order_comments" class="input-text " name="order_comments"></textarea>
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="order-review-wrapper">
                                                        ...
                                                        <form method="POST" action="{{ route('checkout.place') }}">
                                                            ...
                                                            <ul class="wc_payment_methods payment_methods methods">
                                                                ...
                                                                <li class="wc_payment_method payment_method_momo">
                                                                    <input type="radio" data-order_button_text="" value="momo" name="payment_method" class="input-radio" id="payment_method_momo">
                                                                    <label for="payment_method_momo">Thanh toán qua Momo</label>
                                                                </li>
                                                            </ul>
                                                            <div class="form-row place-order">
                                                                <p class="form-row terms wc-terms-and-conditions woocommerce-validated">
                                                                    <label class="woocommerce-form__label woocommerce-form__label-for-checkbox checkbox">
                                                                        ...
                                                                        <span>Tôi đã đọc và đồng ý với <a class="woocommerce-terms-and-conditions-link" href="terms-and-conditions.html">các điều khoản &amp; điều kiện</a></span>
                                                    ...
                                                    <script>
                                                        document.getElementById('place_order_button').addEventListener('click', function() {
                                                            ...
                                                            if (!termsChecked) {
                                                                alert('Bạn cần đồng ý với các điều khoản & điều kiện.');
                                                                return;
                                                            }
                                                    
                                                            // Tạo form ẩn để gửi dữ liệu
                                                            const form = document.createElement('form');
                                                            form.method = 'POST'; // Phương thức gửi
                                                            form.action = '{{ route("checkout.place") }}'; // Đường dẫn đến controller xử lý
