                                                    ...
                                                    @foreach ($relatedProducts as $product1)
                                                        <div class="product">
                                                            ...
                                                            <a href="{{ route('users.products.show', $product1->id) }}"
                                                                ...
                                                                @if ($product1->image)
                                                                    <img src="{{ Storage::url($product1->image) }}" width="224"
                                                                    height="197" class="wp-post-image" alt="$product1->name">
                                                                @else
                                                                    <span>Không có ảnh</span>
                                                                @endif
                                                                <span class="price">
                                                                    <ins>
                                                                        <span class="amount">{{ number_format($product1->variants->first()->sale_price, 0, ',', '.') }}đ</span>
                                                                    </ins>
                                                                    <del>
                                                                        <span class="amount">{{ number_format($product1->variants->first()->listed_price, 0, ',', '.') }}đ</span>
                                                                    </del>
                                                                    <span class="amount"> </span>
                                                                </span>
                                                                <!-- /.price -->
                                                                <h2 class="woocommerce-loop-product__title">{{ $product1->name }}</h2>
                                                            </a>
                                                            <div class="hover-area">
                                                                <form action="{{route('cart.store')}}" enctype="multipart/form-data" method="post" class="cart">
                                                                    @csrf
                                                                    <input type="hidden" name="variant_id" value="{{ $product1->variants->first()->id }}">
