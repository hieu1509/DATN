        ...
        <div class="row">
            ...
            <form class="navbar-search" method="get" action="home-v1.html">
                ...
                <div class="input-group">
                    <input type="text" id="search" class="form-control search-field product-search-field" dir="ltr" value="" name="s" placeholder="Tìm kiếm" />
            ...
            <div class="row">
                <nav id="navbar-primary" class="navbar-primary text-center" aria-label="Navbar Primary" data-nav="flex-menu">
                    <ul id="menu-navbar-primary" class="nav yamm">
                        ...
                        <li class="menu-item animate-dropdown">
                            <a title="ACCESORIES" href="product-category.html">Chính sách bảo mật &#038; Điều khoản</a>
                        </li>
                        {{-- <li class="menu-item animate-dropdown">
